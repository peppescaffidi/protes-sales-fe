...
@Component({
  selector: 'app-protes-chart',
  templateUrl: './protes-chart.component.html',
  styleUrls: ['./protes-chart.component.scss']
})
export class ProtesChartComponent implements  OnDestroy, AfterViewInit {
  ...
  ngAfterViewInit(): void {
    setTimeout(() => {
      ...
      this.dataService.getNationalChart(this.productId, this.countryId).subscribe(data => {
        this.chartData = data;
        this.createChart();
      });
    });
